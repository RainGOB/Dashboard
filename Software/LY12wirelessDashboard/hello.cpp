...
*/
    if(packStr[0] == '1'){
        ...
        xlsx.write(row_num+1, 21, packStr[10] .toInt());  //Acx
        xlsx.write(row_num+1, 22, packStr[11] .toInt());  //Acy
        xlsx.write(row_num+1, 23, packStr[12] .toInt());  //Acz
//        xlsx.write(row_num, 21, packStr[0] .toInt());  //编号
        ...
        xlsx.write(row_num, 24, packStr[12].toInt()); //方向盘转角
//        xlsx.write(row_num, 21, packStr[0] .toInt());  //编号
    }
